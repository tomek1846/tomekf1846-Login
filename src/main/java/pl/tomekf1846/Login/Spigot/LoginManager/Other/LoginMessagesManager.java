...
public class LoginMessagesManager {
    ...
    private static void showRegisterInfo(Player player, int time) {
        ...
        sendRepeatingMessage(player, "messages.player-commands.register-message");
    }
    ...
    private static void showLoginInfo(Player player, int time) {
        ...
        sendRepeatingMessage(player, "messages.player-commands.login-message");
    }
        ...
        BukkitRunnable countdownTask = new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (remainingTime <= 0) {
                    ...
                    String bossBarMessage = LanguageManager.getMessage(player, bossBarMessageKey).replace("{seconds}", String.valueOf(remainingTime));
        ...
        BukkitRunnable messageTask = new BukkitRunnable() {
            ...
            public void run() {
                player.sendMessage(LanguageManager.getMessage(player, "messages.prefix.main-prefix")
                        + LanguageManager.getMessage(player, message));
            }
        };
