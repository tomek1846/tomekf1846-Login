...
public class AdminCommandPremiumCracked {
    ...
    private static void setPlayerStatus(CommandSender sender, String playerName, boolean premiumStatus, String newPassword) {
        ...
        if (sender.getName().equalsIgnoreCase(playerName)) {
            sender.sendMessage(prefix + languageManager.getMessage(sender, "messages.admin-commands.cannot_change_own_status"));
            return;
        }
        ...
        if (!isPremiumCommandEnabled) {
            sender.sendMessage(prefix + languageManager.getMessage(sender, "messages.admin-commands.premium_command_disabled"));
            return;
        }
        ...
        if (playerData == null) {
            sender.sendMessage(prefix + languageManager.getMessage(sender, "messages.admin-commands.player_file_not_found"));
            return;
        }
        ...
        if (currentPremium != null && currentPremium.equalsIgnoreCase(String.valueOf(premiumStatus))) {
            sender.sendMessage(prefix + languageManager.getMessage(sender,
        ...
        if (PlayerDataSave.setPlayerSession(playerName, premiumStatus)) {
            sender.sendMessage(prefix + languageManager.getMessage(sender, "messages.admin-commands.player_status_updated")
            ...
            sender.sendMessage(prefix + languageManager.getMessage(sender, "messages.admin-commands.failed_to_update_player"));
        }
    }
}
