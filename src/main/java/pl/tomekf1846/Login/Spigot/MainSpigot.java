...
import pl.tomekf1846.Login.Spigot.GUI.PlayerManage.PlayerManageGuiListener;
import pl.tomekf1846.Login.Spigot.GUI.PlayerManage.PlayerManageLanguageGuiListener;
...
public final class MainSpigot extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new PlayerManageGuiListener(), this);
        getServer().getPluginManager().registerEvents(new PlayerManageChatListener(), this);
        getServer().getPluginManager().registerEvents(new PlayerManageLanguageGuiListener(), this);
        getServer().getPluginManager().registerEvents(new PlayerManageConfirmGuiListener(), this);
